...
export default function FormulariosGenerales({
  ...
  const formularioCompleto = submitted ? (
    <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 text-center max-w-2xl mx-auto">
      ...
      <h2 className="text-2xl font-bold text-gray-900 mb-3">¡Formulario Enviado!</h2>
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-4">
        <p className="text-[#1e3a8a] font-medium">
          Su solicitud estará resuelta en un plazo de 5 a 10 días hábiles.
        </p>
      </div>
      <button onClick={() => setSubmitted(false)} className="bg-blue-500 text-white px-6 py-3 rounded-lg hover:bg-blue-600 transition-colors">
        Nueva Solicitud
      </button>
    </div>
  ) : (
